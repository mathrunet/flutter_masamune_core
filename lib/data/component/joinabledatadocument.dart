...
abstract class _DocumentJoinEntry {
  final String prefix;
  const _DocumentJoinEntry({this.prefix});
}
...
class _DocumentJoinDocumentEntry extends _DocumentJoinEntry {
  ...
  const _DocumentJoinDocumentEntry(
      {String key, String prefix, this.document, this.onApply})
      : super(prefix: prefix);
}
...
class _DocumentJoinCollectionEntry extends _DocumentJoinEntry {
  ...
  const _DocumentJoinCollectionEntry(
      {this.key,
      String prefix,
      this.test,
      this.collection,
